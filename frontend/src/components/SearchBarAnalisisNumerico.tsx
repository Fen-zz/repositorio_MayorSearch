    ...
    <div className="flex flex-col items-center w-full">
      ...
      {showFilters && (
        <div className="mt-4 p-4 w-3/4 max-w-3xl bg-white rounded-xl shadow-md border border-gray-100">
          <h3 className="font-semibold mb-2 text-[#a4161a]">
              ...
              {["Libro", "Articulo", "Tesis", "Monografia", "Documento", "Apuntes"].map((x) => (
                <p
                  ...
                  className={`cursor-pointer hover:text-[#a4161a] ${
                    filters.tipo === x ? "text-[#a4161a] font-semibold" : ""
                  }`}
                >
                  {x}
                </p>
            ...
            <div>
              ...
              {["Basico", "Intermedio", "Avanzado"].map((x) => (
                <p
                  ...
                  className={`cursor-pointer hover:text-[#a4161a] ${
                    filters.nivel === x ? "text-[#a4161a] font-semibold" : ""
                  }`}
                >
                  {x}
                </p>
            ...
            <div>
              ...
              {["Inglés", "Español", "Otro..."].map((x) => (
                <p
                  ...
                  className={`cursor-pointer hover:text-[#a4161a] ${
                    filters.idioma === x ? "text-[#a4161a] font-semibold" : ""
                  }`}
                >
                  {x}
                </p>
